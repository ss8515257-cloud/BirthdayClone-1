  ...
  return (
    <div className="relative z-20 mx-auto w-full max-w-xl">
      <div className="mb-4 flex items-center justify-between px-2">
        <p className="font-dancing text-lg text-rose-pink/80">
          {BIRTHDAY_WISHES_META.featuredHint}
        </p>
        <button
          type="button"
          onClick={togglePause}
          className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-cream-white/70 backdrop-blur transition hover:bg-white/20"
      ...
      <div
        className={cn(
          'relative overflow-hidden rounded-3xl border border-white/20 p-8 text-center shadow-premium backdrop-blur-md sm:p-10',
      ...
      >
        ...
        <AnimatePresence mode="wait">
          <motion.blockquote
            key={activeIndex}
            className="font-dancing text-xl leading-relaxed text-cream-white sm:text-2xl"
        ...
        <p className="mt-6 font-poppins text-xs uppercase tracking-widest text-cream-white/40">
